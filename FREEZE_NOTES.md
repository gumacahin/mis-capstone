...
- Planner endpoints are typed manually in frontend hooks. The planner API should
  be added to the generated OpenAPI client or moved into a dedicated typed
  planner client module.
...
1. Add generated or dedicated typed planner client code.
